...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = getCommand(f'MIRROR_COMMAND', f'leech{CMD_SUFFIX}'), f'm{CMD_SUFFIX}'
        ...
        self.LeechCommand = getCommand(f'LEECH_COMMAND', f'leech1{CMD_SUFFIX}'), f'l{CMD_SUFFIX}'
